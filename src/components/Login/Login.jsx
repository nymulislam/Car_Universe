...
const Login = () => {
  ...
  return (
    <div className="box-container pt-28 pb-14 login-box">
      <div className="box">
        ...
        <form onSubmit={handleLogin}>
          ...
          <button className="btn bt ms text-[#ff4605] hover:bg-[#ff4605] bg-[rgba(0,0,0,0.5)] hover:text-white font-bold text-base border-[#ff4605] normal-case">Login</button>
